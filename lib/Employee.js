    ...
    for (let i = 0; i < employeeStore.length; i++) {
        ...
        <div class="col">
            <div class="p-3 bg-primary text-white">
                <div class="text-white">${tempStore[i].name}</div>
                <div class="text-white">${tempStore[i].role}</div>
            </div>
            <div>
                <div class="p-3 border bg-light">ID: ${tempStore[i].id}</div>
                <div class="p-3 border bg-light">Email: ${tempStore[i].email}</div>
